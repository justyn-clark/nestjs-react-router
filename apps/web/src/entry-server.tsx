...
export function pipeToNodeWritable(replyRaw: NodeJS.WritableStream, router: any, context: any, nonce?: string) {
  ...
  const close = `</div><script ${nonce ? `nonce="${nonce}"` : ""} type="module" src="/static/entry-client.js"></script></body></html>`;
  replyRaw.write(open);
